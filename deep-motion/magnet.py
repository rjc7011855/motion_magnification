...
class MagNet3Frames(object):
    ...
    def __init__(self, sess, name, arch_config):
        ...
        self.encoder_dims = arch_config["ynet_3frames"]["enc_dims"]     #32
        self.num_enc_resblk = arch_config["ynet_3frames"]["num_enc_resblk"]
        self.num_man_resblk = arch_config["ynet_3frames"]["num_man_resblk"]      #1
        self.num_man_conv = arch_config["ynet_3frames"]["num_man_conv"]     #1
        self.num_man_aft_conv = arch_config["ynet_3frames"]["num_man_aft_conv"]     #1
        ...
        self.manipulator = partial(res_manipulator,
                                   layer_dims=self.encoder_dims,   #32
                                   num_resblk=self.num_man_resblk,  #1
                                   num_conv=self.num_man_conv,    #1
                                   num_aft_conv=self.num_man_aft_conv,      #1
    ...
    def _loss_function(self, a, b, train_config):
        ...
        with tf.variable_scope("loss_function"):
            return L1_loss(a, b) * train_config["l1_loss_weight"]       # train_config["l1_loss_weight"]=1
